...
import SS_Author from './Foto/Screenshot_Author.png'
import SS_About_App from './Foto/Screenshot_About_App.png'
import SS_Not_Found from './Foto/Screenshot_Not_Found.png'
        ...
        <main className="col ps-md-2 mt-0">
          ...
          <div className="container-fluid row">
            <div className="col-12 mt-2">
              <h2>React Routing</h2>
              <p>Melanjutkan aplikasi daftar tugas (todo list) pada tugas React Fundamental dengan menambahkan 
                  halaman about dan menerapkan routing untuk perpindahan halaman website</p>
              <a href='https://react-routing-one.vercel.app/' target="_blank" rel='noreferrer'>Halaman Website task React Routing</a><br />
              <img src={SS_Home} style={{ height:"20%", width:"80%" }} alt="" /> <br /><br />
              <img src={SS_About} style={{ height:"20%", width:"80%" }} alt="" /> <br /><br />
              <img src={SS_Author} style={{ height:"20%", width:"80%" }} alt="" /> <br /><br />
              <img src={SS_About_App} style={{ height:"20%", width:"80%" }} alt="" /> <br /><br />
              <img src={SS_Not_Found} style={{ height:"20%", width:"80%" }} alt="" /> <br /><br />
            </div>
          </div>
        </main>
      </div>
