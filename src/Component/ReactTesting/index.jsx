...
import SS_Testing from './Foto/Screenshot_Hasil_Testing.png'
        ...
        <main className="col ps-md-2 mt-0">
          ...
          <div className="container-fluid row">
            <div className="col-12 mt-2">
              <h2>Testing</h2>
              <p>Melakukan Testing terhadap asset aplikasi react yang sudah diberikan.</p>
              <img src={SS_Testing} style={{ height:"90%", width:"90%" }} alt="" /> <br /><br />
            </div>
          </div>
        </main>
      </div>
